...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <label class="required" for="Id_Con"><?=t('Descripcion_Rol'); ?> <?php echo form_error('Descripcion_Rol') ?></label>
                    <div class="input-group-prepend group-ico">
                        <i class="fas fa-sort-alpha-down text-muted inputIco"></i>
                        <input type="text" class="form-control" name="Descripcion_Rol" id="Descripcion_Rol" placeholder="" value="<?=$Descripcion_Rol; ?>" readonly/>
                    </div>
