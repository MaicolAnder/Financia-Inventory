            ...
            <div id="action_filter_collapse" class="collapse col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <form id="form_filter_collapse" class="row" method="post">
                        ...
                        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <label for="Id_BodEst"><?=t('Id_BodEst'); ?> <?php echo form_error('Id_BodEst') ?></label>
                            <select name="Id_BodEst" id="Id_BodEst" class="form-control selectpicker" data-live-search="true">
                                <option value="">Seleccione</option>
                                <?php
                                foreach($all_bodega_estado as $bodega_estado)
                                { 
                                    $print_value =  $bodega_estado->Id_BodEst;
                                    $selected = '';
                                    if (isset($Id_BodEst)) {
                        ...
                        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            ...
                            <select name="Id_BodTip" id="Id_BodTip" class="form-control selectpicker" data-live-search="true">
                                ...
                                { 
                                    $print_value =  $bodega_tipo->Id_BodTip;
                                    $selected = '';
                                    if (isset($Id_BodTip)) {
            ...
            <table id="mytable" class="table table-fixed table-condensed table-hover table-sm" width="100%">
                <thead>
                    <tr>
                		...
                		<th><?=t('Nombre_Bod'); ?></th>
                		<th><?=t('Codigo_Bod'); ?></th>
                		<th><?=t('Direccion_Bod'); ?></th>
                		<th><?=t('Descripcion_Bod'); ?></th>
                		<th><?=t('FechaRegistro_Bod'); ?></th>
                		<th><?=t('FechaCreacion_Bod'); ?></th>
                		<th><?=t('Id_BodTip'); ?></th>
                		<th><?=t('Id_BodEst'); ?></th>
                		<th><?=t('Id_Usu'); ?></th>
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    columns: [
                        ...
                        {"data": "Nombre_Bod"},{"data": "Codigo_Bod"},{"data": "Direccion_Bod"},{"data": "Descripcion_Bod"},{"data": "FechaRegistro_Bod"},{"data": "FechaCreacion_Bod"},{"data": "Nombre_BodTip"},{"data": "Nombre_BodEst"},{"data": "Usuario_Usu"}
