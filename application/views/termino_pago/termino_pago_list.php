    ...
    <div class="card">
		...
		<th><?=t('Nombre_TerPag'); ?></th>
		<th><?=t('Dias_TerPag'); ?></th>
		<th><?=t('Estado_TerPag'); ?></th>
		<th><?=t('FechaRegistro_TerPag'); ?></th>
		<th><?=t('Primary_Usu'); ?></th>
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    columns: [
                        ...
                        {"data": "Nombre_TerPag"},{"data": "Dias_TerPag"},{"data": "Estado_TerPag"},{"data": "FechaRegistro_TerPag"},{"data": "Primary_Usu"}
