...
<div class="card">
    ...
    <div class="card-header">
        <!-- <h2 style="margin-top:0px">Metodo_pago Read</h2> -->
    ...
    <div class="card-body">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <label class="required" for="Id_Con"><?=t('Nombre_MetPag'); ?> <?php echo form_error('Nombre_MetPag') ?></label>
                    <div class="input-group-prepend group-ico">
                        <i class="fas fa-sort-alpha-down text-muted inputIco"></i>
                        <input type="text" class="form-control" name="Nombre_MetPag" id="Nombre_MetPag" placeholder="" value="<?=$Nombre_MetPag; ?>" readonly/>
                    </div>
                </div><div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <label class="required" for="Id_Con"><?=t('Estado_MePag'); ?> <?php echo form_error('Estado_MePag') ?></label>
                    <div class="input-group-prepend group-ico">
                        <i class="fas fa-sort-alpha-down text-muted inputIco"></i>
                        <input type="text" class="form-control" name="Estado_MePag" id="Estado_MePag" placeholder="" value="<?=$Estado_MePag; ?>" readonly/>
                    </div>
                </div><div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
