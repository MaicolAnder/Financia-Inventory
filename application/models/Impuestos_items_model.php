...
class Impuestos_items_model extends CI_Model
{

    public $table = 'impuestos_items';
    public $id = 'Id_Ite';
    public $order = 'DESC';
    ...
    function json(
        $search_fields=[],
        $links=[],
        $view = 'impuestos_items',
        $elements = 'Id_Ite,Id_Imp', 
        $find_id = 'Id_Ite',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'impuestos_items.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('impuestos_items/read/$1'),'Read')." | ".anchor(site_url('impuestos_items/update/$1'),'Update')." | ".anchor(site_url('impuestos_items/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('impuestos_items/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('impuestos_items/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('impuestos_items/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
...
/* End of file Impuestos_items_model.php */
/* Location: ./application/models/Impuestos_items_model.php */
