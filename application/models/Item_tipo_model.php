...
class Item_tipo_model extends CI_Model
{

    public $table = 'item_tipo';
    public $id = 'Id_IteTip';
    public $order = 'DESC';
    ...
    function json(
        ...
        $links=[],
        $view = 'item_tipo',
        $elements = 'Id_IteTip,Nombre_IteTip,FechaRegistro_IteTip,Estado_IteTip', 
        $find_id = 'Id_IteTip',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'item_tipo.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('item_tipo/read/$1'),'Read')." | ".anchor(site_url('item_tipo/update/$1'),'Update')." | ".anchor(site_url('item_tipo/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('item_tipo/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('item_tipo/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('item_tipo/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
        if ($q != NULL) {
			$this->db->like('Id_IteTip', $q);
			$this->db->or_like('Nombre_IteTip', $q);
			$this->db->or_like('FechaRegistro_IteTip', $q);
			$this->db->or_like('Estado_IteTip', $q);
		}
...
/* End of file Item_tipo_model.php */
/* Location: ./application/models/Item_tipo_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-05-10 01:50:05 */
/* www.margunsoft.com */