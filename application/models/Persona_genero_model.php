...
class Persona_genero_model extends CI_Model
{

    public $table = 'persona_genero';
    public $id = 'Id_PerGen';
    public $order = 'DESC';
    ...
    function json(
        ...
        $links=[],
        $view = 'persona_genero',
        $elements = 'Id_PerGen,Descripcion_PerGen,Codigo_PerGen', 
        $find_id = 'Id_PerGen',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'persona_genero.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('persona_genero/read/$1'),'Read')." | ".anchor(site_url('persona_genero/update/$1'),'Update')." | ".anchor(site_url('persona_genero/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('persona_genero/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('persona_genero/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('persona_genero/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
...
/* End of file Persona_genero_model.php */
/* Location: ./application/models/Persona_genero_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-05-10 01:50:16 */
/* www.margunsoft.com */