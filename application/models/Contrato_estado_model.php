...
class Contrato_estado_model extends CI_Model
{

    public $table = 'contrato_estado';
    public $id = 'Id_ConEst';
    public $order = 'DESC';
    ...
    function json(
        $search_fields=[],
        $links=[],
        $view = 'contrato_estado',
        $elements = 'Id_ConEst,Nombre_ConEst', 
        $find_id = 'Id_ConEst',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'contrato_estado.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('contrato_estado/read/$1'),'Read')." | ".anchor(site_url('contrato_estado/update/$1'),'Update')." | ".anchor(site_url('contrato_estado/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('contrato_estado/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('contrato_estado/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('contrato_estado/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
        if ($q != NULL) {
			$this->db->like('Id_ConEst', $q);
			$this->db->or_like('Nombre_ConEst', $q);
		}
...
/* End of file Contrato_estado_model.php */
/* Location: ./application/models/Contrato_estado_model.php */
