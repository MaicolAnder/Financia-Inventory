...
class Medidas_model extends CI_Model
{
    ...
    function json(
        ...
        $links=[],
        $view = 'medidas',
        $elements = 'Id_Med,Nombre_Med,Valor_Med,Unidad_Med,Estado_Med,Primary_Usu', 
        $find_id = 'Id_Med',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'medidas.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('medidas/read/$1'),'Read')." | ".anchor(site_url('medidas/update/$1'),'Update')." | ".anchor(site_url('medidas/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('medidas/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('medidas/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('medidas/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
...
/* End of file Medidas_model.php */
/* Location: ./application/models/Medidas_model.php */
