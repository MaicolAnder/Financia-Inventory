...
class Bodega_tipo_model extends CI_Model
{

    public $table = 'bodega_tipo';
    public $id = 'Id_BodTip';
    public $order = 'DESC';
    ...
    function json(
        ...
        $links=[],
        $view = 'bodega_tipo',
        $elements = 'Id_BodTip,Nombre_BodTip,Estado_BodTip,FechaRegistro_BodTip,Primary_Usu', 
        $find_id = 'Id_BodTip',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'bodega_tipo.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('bodega_tipo/read/$1'),'Read')." | ".anchor(site_url('bodega_tipo/update/$1'),'Update')." | ".anchor(site_url('bodega_tipo/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('bodega_tipo/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('bodega_tipo/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('bodega_tipo/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
		$this->db->where($this->table.'.Primary_Usu', $this->session->userdata('Primary_Usu'));
        if ($q != NULL) {
			$this->db->like('Id_BodTip', $q);
			$this->db->or_like('Nombre_BodTip', $q);
			$this->db->or_like('Estado_BodTip', $q);
			$this->db->or_like('FechaRegistro_BodTip', $q);
...
/* End of file Bodega_tipo_model.php */
/* Location: ./application/models/Bodega_tipo_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-05-10 01:49:51 */
/* www.margunsoft.com */