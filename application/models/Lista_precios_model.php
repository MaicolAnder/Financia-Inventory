...
class Lista_precios_model extends CI_Model
{
    ...
    function json(
        ...
        $links=[],
        $view = 'lista_precios',
        $elements = 'Id_ListPre,Nombre_ListPre,Estado_ListPre,Valor_Incremento,Porcentaje_Incremento,Primary_Usu', 
        $find_id = 'Id_ListPre',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'lista_precios.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('lista_precios/read/$1'),'Read')." | ".anchor(site_url('lista_precios/update/$1'),'Update')." | ".anchor(site_url('lista_precios/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('lista_precios/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('lista_precios/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('lista_precios/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
		$this->db->where($this->table.'.Primary_Usu', $this->session->userdata('Primary_Usu'));
        if ($q != NULL) {
			$this->db->like('Id_ListPre', $q);
			$this->db->or_like('Nombre_ListPre', $q);
			$this->db->or_like('Estado_ListPre', $q);
			$this->db->or_like('Valor_Incremento', $q);
			$this->db->or_like('Porcentaje_Incremento', $q);
...
/* End of file Lista_precios_model.php */
/* Location: ./application/models/Lista_precios_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-05-10 01:50:08 */
/* www.margunsoft.com */