...
class Item_estado_model extends CI_Model
{

    public $table = 'item_estado';
    public $id = 'Id_IteEst';
    public $order = 'DESC';
    ...
    function json(
        ...
        $links=[],
        $view = 'item_estado',
        $elements = 'Id_IteEst,Nombre_IteEst', 
        $find_id = 'Id_IteEst',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'item_estado.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('item_estado/read/$1'),'Read')." | ".anchor(site_url('item_estado/update/$1'),'Update')." | ".anchor(site_url('item_estado/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('item_estado/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('item_estado/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('item_estado/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
...
/* End of file Item_estado_model.php */
/* Location: ./application/models/Item_estado_model.php */
