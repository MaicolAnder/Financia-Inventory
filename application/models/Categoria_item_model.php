...
class Categoria_item_model extends CI_Model
{
    ...
    function json(
        ...
        $links=[],
        $view = 'categoria_item',
        $elements = 'Id_CatIte,Nombre_CatIte,FechaRegistro_CatIte,Estado_CatIte,Primary_Usu', 
        $find_id = 'Id_CatIte',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'categoria_item.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('categoria_item/read/$1'),'Read')." | ".anchor(site_url('categoria_item/update/$1'),'Update')." | ".anchor(site_url('categoria_item/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('categoria_item/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('categoria_item/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('categoria_item/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
		$this->db->where($this->table.'.Primary_Usu', $this->session->userdata('Primary_Usu'));
        if ($q != NULL) {
			$this->db->like('Id_CatIte', $q);
			$this->db->or_like('Nombre_CatIte', $q);
			$this->db->or_like('FechaRegistro_CatIte', $q);
			$this->db->or_like('Estado_CatIte', $q);
...
/* End of file Categoria_item_model.php */
/* Location: ./application/models/Categoria_item_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-05-10 01:49:52 */
/* www.margunsoft.com */