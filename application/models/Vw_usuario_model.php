...
class Vw_usuario_model extends CI_Model
{

    public $table = 'vw_usuario';
    public $id = 'Id_Usu';
    public $order = 'DESC';
    ...
    function json(
        ...
        $links=[],
        $view = 'vw_usuario',
        $elements = 'Id_Usu,nombres,Email_Usu,UltimoAcceso_Usu,UltimaContrasena_Usu,KeyPago_Usu,Descripcion_UsuEst,Descripcion_Rol,Primary_Usu', 
        $find_id = '',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'vw_usuario.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('vw_usuario/read/$1'),'Read')." | ".anchor(site_url('vw_usuario/update/$1'),'Update')." | ".anchor(site_url('vw_usuario/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('vw_usuario/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('vw_usuario/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('vw_usuario/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
        ...
        if ($q != NULL) {
			...
			$this->db->or_like('Descripcion_UsuEst', $q);
			$this->db->or_like('Descripcion_Rol', $q);
...
/* End of file Vw_usuario_model.php */
/* Location: ./application/models/Vw_usuario_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-05-10 01:50:33 */
/* www.margunsoft.com */