...
class Contrato_tipo_model extends CI_Model
{

    public $table = 'contrato_tipo';
    public $id = 'Id_ConTip';
    public $order = 'DESC';
    ...
    function json(
        ...
        $links=[],
        $view = 'contrato_tipo',
        $elements = 'Id_ConTip,Nombre_ConTip,Estado_ConTip', 
        $find_id = 'Id_ConTip',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'contrato_tipo.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('contrato_tipo/read/$1'),'Read')." | ".anchor(site_url('contrato_tipo/update/$1'),'Update')." | ".anchor(site_url('contrato_tipo/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('contrato_tipo/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('contrato_tipo/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('contrato_tipo/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
        if ($q != NULL) {
			$this->db->like('Id_ConTip', $q);
			$this->db->or_like('Nombre_ConTip', $q);
			$this->db->or_like('Estado_ConTip', $q);
		}
...
/* End of file Contrato_tipo_model.php */
/* Location: ./application/models/Contrato_tipo_model.php */
