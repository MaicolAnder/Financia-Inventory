...
class Vw_kardex_model extends CI_Model
{

    public $table = 'vw_kardex';
    public $id = 'Id_kar';
    public $order = 'DESC';
    ...
    function json(
        ...
        $links=[],
        $view = 'vw_kardex',
        $elements = 'Id_kar,Cantidad_Kar,Costo_Kar,Descuento_Kar,Aceptado_Kar,Observacion_Kar,FactorMovimiento_Kar,Nombre_Ite,Nombre_Med,Nombre_Bod,Nombre_KarTip,Nombre_KarEst,Unidad_Med,subtotal,descuento,impuestos,total,Id_Doc,Id_Ite,Id_Med,Id_Bod,Id_KarTip,Id_KarEst,Primary_Usu', 
        $find_id = '',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'vw_kardex.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('vw_kardex/read/$1'),'Read')." | ".anchor(site_url('vw_kardex/update/$1'),'Update')." | ".anchor(site_url('vw_kardex/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('vw_kardex/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('vw_kardex/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('vw_kardex/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
        ...
        if ($q != NULL) {
			...
			$this->db->or_like('Nombre_KarTip', $q);
			$this->db->or_like('Nombre_KarEst', $q);
			$this->db->or_like('Unidad_Med', $q);
			$this->db->or_like('subtotal', $q);
			$this->db->or_like('descuento', $q);
			$this->db->or_like('impuestos', $q);
...
/* End of file Vw_kardex_model.php */
/* Location: ./application/models/Vw_kardex_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-05-10 01:50:31 */
/* www.margunsoft.com */