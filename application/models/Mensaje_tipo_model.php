...
class Mensaje_tipo_model extends CI_Model
{

    public $table = 'mensaje_tipo';
    public $id = 'Id_MenTip';
    public $order = 'DESC';
    ...
    function json(
        ...
        $links=[],
        $view = 'mensaje_tipo',
        $elements = 'Id_MenTip,Nombre_MenTip', 
        $find_id = 'Id_MenTip',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'mensaje_tipo.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('mensaje_tipo/read/$1'),'Read')." | ".anchor(site_url('mensaje_tipo/update/$1'),'Update')." | ".anchor(site_url('mensaje_tipo/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('mensaje_tipo/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('mensaje_tipo/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('mensaje_tipo/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
        if ($q != NULL) {
			$this->db->like('Id_MenTip', $q);
			$this->db->or_like('Nombre_MenTip', $q);
		}
...
/* End of file Mensaje_tipo_model.php */
/* Location: ./application/models/Mensaje_tipo_model.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-05-10 01:50:11 */
/* www.margunsoft.com */