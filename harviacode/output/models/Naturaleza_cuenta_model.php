...
class Naturaleza_cuenta_model extends CI_Model
{

    public $table = 'naturaleza_cuenta';
    public $id = 'Id_NatCue';
    public $order = 'DESC';
    ...
    function json(
        $search_fields=[],
        $links=[],
        $view = 'naturaleza_cuenta',
        $elements = 'Id_NatCue,Nombre_NatCue', 
        $find_id = 'Id_NatCue',
        $join=[]) {
        ...
        //$this->datatables->join('table2', 'naturaleza_cuenta.field = table2.field');
        //$this->datatables->add_column('action', anchor(site_url('naturaleza_cuenta/read/$1'),'Read')." | ".anchor(site_url('naturaleza_cuenta/update/$1'),'Update')." | ".anchor(site_url('naturaleza_cuenta/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), $find_id);
        // Métodos estaticos para link en respuesta de datatables
        // $this->datatables->add_column('ver', anchor(site_url('naturaleza_cuenta/read/$1'),'<i class="fas fa-eye"></i>',array('title'=>'Ver registro','class' => 'btn btn-info')),$find_id);
        // $this->datatables->add_column('actualizar', anchor(site_url('naturaleza_cuenta/update/$1'),'<i class="fas fa-pencil-alt"></i>',array('title'=>'Actualizar','class' => 'btn btn-primary2')),$find_id);
        // $this->datatables->add_column('eliminar', anchor(site_url('naturaleza_cuenta/delete/$1'),'<i class="fas fa-trash-alt"></i>',array('title'=>'Eliminar','class' => 'btn btn-danger', 'onclick'=>'javasciprt: return confirm(\'¿Esta seguro?\')')),$find_id);
    ...
    function total_rows($q = NULL) {
        if ($q != NULL) {
			$this->db->like('Id_NatCue', $q);
			$this->db->or_like('Nombre_NatCue', $q);
		}
...
/* End of file Naturaleza_cuenta_model.php */
/* Location: ./application/models/Naturaleza_cuenta_model.php */
