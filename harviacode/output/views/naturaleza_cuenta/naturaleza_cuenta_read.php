...
<div class="card">
    ...
    <div class="card-header">
        <!-- <h2 style="margin-top:0px">Naturaleza_cuenta Read</h2> -->
    ...
    <div class="card-body">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <label class="required" for="Id_Con"><?=t('Nombre_NatCue'); ?> <?php echo form_error('Nombre_NatCue') ?></label>
                    <div class="input-group-prepend group-ico">
                        <i class="fas fa-sort-alpha-down text-muted inputIco"></i>
                        <input type="text" class="form-control" name="Nombre_NatCue" id="Nombre_NatCue" placeholder="" value="<?=$Nombre_NatCue; ?>" readonly/>
                    </div>
                </div>
