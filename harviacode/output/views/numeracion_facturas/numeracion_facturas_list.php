    ...
    <div class="card">
		...
		<th><?=t('Nombre_NumFac'); ?></th>
		<th><?=t('Prefijo_NumFac'); ?></th>
		<th><?=t('Numero_NumFac'); ?></th>
		<th><?=t('Resolucion_NumFac'); ?></th>
		<th><?=t('Activo_NumFac'); ?></th>
		<th><?=t('Defecto_NumFac'); ?></th>
		<th><?=t('Primary_Usu'); ?></th>
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    columns: [
                        ...
                        {"data": "Nombre_NumFac"},{"data": "Prefijo_NumFac"},{"data": "Numero_NumFac"},{"data": "Resolucion_NumFac"},{"data": "Activo_NumFac"},{"data": "Defecto_NumFac"},{"data": "Primary_Usu"}
