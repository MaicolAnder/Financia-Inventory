...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    ...
                    <label class="required" for="Id_Con"><?=t('Numero_NumFac'); ?> <?php echo form_error('Numero_NumFac') ?></label>
                    <div class="input-group-prepend group-ico">
                        <i class="fas fa-sort-alpha-down text-muted inputIco"></i>
                    ...
                    <div class="input-group-prepend group-ico">
                        <i class="fas fa-sort-alpha-down text-muted inputIco"></i>
                        <input type="text" class="form-control" name="Resolucion_NumFac" id="Resolucion_NumFac" placeholder="" value="<?=$Resolucion_NumFac; ?>" readonly/>
                    </div>
                </div><div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
